...
import { Upload, X, Package, Trash2, Archive, ArrowUp, ArrowDown, Share2, UserPlus, Calendar, AlertTriangle, Receipt, Download, FileText } from 'lucide-react';
...
import { Modal, ModalHeader, ModalTitle, ModalContent, ModalFooter, ModalDescription } from '@/components/ui/modal';
...
import type { Batch, Media, PriceUnit, BatchStatus, User, SharedInventoryBatch, Sale } from '@/lib/types';
