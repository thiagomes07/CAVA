      ...
      <div className="page-header">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Button
              variant="secondary"
              onClick={() => router.push(`/${slug}/portfolio/share`)}
            >
            ...
            <Button
              variant="primary"
              onClick={() => router.push(`/${slug}/portfolio/new`)}
            >
          ...
          <EmptyState
            ...
            onAction={() => {
              if (hasFilters) {
                ...
                router.push(`/${slug}/portfolio/new`);
              }
            }}
          />
        ) : (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {products.map((product) => (
                <ProductCard
                  ...
                  product={product}
                  onView={() =>
                    router.push(`/${slug}/inventory?productId=${product.id}`)
                  }
                  onEdit={() => router.push(`/${slug}/portfolio/edit/${product.id}`)}
                  translations={{
                    noPhoto: t("noPhoto"),
                    edit: t("edit"),
