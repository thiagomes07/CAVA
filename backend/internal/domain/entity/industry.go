...
type Industry struct {
	...
	PortfolioDisplaySettings PortfolioDisplaySettings `json:"portfolioDisplaySettings,omitempty"`
...
// PortfolioDisplaySettings representa as configurações de visibilidade do portfolio público
type PortfolioDisplaySettings struct {
...
func (p PortfolioDisplaySettings) Value() (driver.Value, error) {
	return json.Marshal(p)
}

// Scan implements the sql.Scanner interface
func (p *PortfolioDisplaySettings) Scan(value interface{}) error {
	if value == nil {
		// Return defaults
		*p = PortfolioDisplaySettings{
			ShowName:      true,
			LocationLevel: "none",
		}
		return nil
